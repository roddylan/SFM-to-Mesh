...
\begin{figure}[ht!]
    \centering
    \subfloat[No Ft. Preproc.]{\includegraphics[width=.15\textwidth]{figures/ppc/lego5/npp_dense.png}}
    \
    \subfloat[Ft. Preproc.]{\includegraphics[width=.14\textwidth]{figures/ppc/lego5/pp_dense.png}}
...
to the resultant point clouds of three datasets (via our SFM-MVS workflow).
These datasets are "lego", "templeRing" \cite{temple}, and "ace"
...
\\
Abdullah Khadelli implemented the feature preprocessing algorithm, interaction with
